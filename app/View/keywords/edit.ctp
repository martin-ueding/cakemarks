...
<div id="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Delete'), array('action' => 'delete', $this->Form->value('Keyword.id')), null, sprintf(__('Are you sure you want to delete # %s?'), $this->Form->value('Keyword.id'))); ?></li>
		<li><?php echo $this->Html->link(__('List Keywords'), array('action' => 'index'));?></li>
	</ul>
</div>

<div id="content" class="keywords_form">
	<h2><?php echo __('Edit Keyword'); ?></h2>
