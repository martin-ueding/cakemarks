...
if ($show_results): ?>
	...
	<h3><?php echo __('Last Import'); ?></h3>
<dl>
	<dt><?php echo __('imported bookmarks'); ?></dt>
	<dd><?php echo $import_result['added_bookmarks']; ?></dd>
	<dt><?php echo __('already existing bookmarks'); ?></dt>
	<dd><?php echo $import_result['existing_bookmarks']; ?></dd>
	<dt><?php echo __('imported keywords'); ?></dt>
	<dd><?php echo $import_result['added_keywords']; ?></dd>
	<dt><?php echo __('already existing keywords'); ?></dt>
