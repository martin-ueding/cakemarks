...
CREATE TABLE `lz_key` (
  ...
  `key_name` varchar(100) COLLATE latin1_german1_ci NOT NULL DEFAULT '',
  `key_bar` int(1) unsigned NOT NULL DEFAULT '0',
  `key_rank` int(5) unsigned NOT NULL DEFAULT '1000',
  `key_parent` int(5) unsigned DEFAULT '0',
  PRIMARY KEY (`key_id`),
...
CREATE TABLE `lz_link` (
  ...
  `link_aktiv` int(1) NOT NULL DEFAULT '1',
  `link_title` varchar(100) COLLATE latin1_german1_ci DEFAULT NULL,
  `link_url` varchar(250) COLLATE latin1_german1_ci DEFAULT NULL,
  `link_hits` int(5) unsigned DEFAULT '0',
  `link_last_hit` int(16) unsigned DEFAULT '0',
  `link_wvl` int(4) unsigned NOT NULL DEFAULT '0',
  `link_added` int(16) unsigned DEFAULT '0',
  PRIMARY KEY (`link_id`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COLLATE=latin1_german1_ci;


CREATE TABLE `lz_quotes` (
  `quotes_id` int(5) unsigned NOT NULL AUTO_INCREMENT,
  `quotes_text` text NOT NULL,
  `quotes_author` varchar(200) DEFAULT NULL,
  `quotes_upvotes` int(5) unsigned NOT NULL DEFAULT '0',
  `quotes_downvotes` int(5) unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`quotes_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;


CREATE TABLE `lz_zaehler` (
  `zaehler_id` int(5) unsigned NOT NULL AUTO_INCREMENT,
  `zaehler_text` varchar(200) COLLATE latin1_german1_ci NOT NULL DEFAULT 'Neuer Z&auml;hler',
  `zaehler_zeit` int(15) unsigned NOT NULL DEFAULT '1',
