...
<div id="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Delete this bookmark', true), array('action' => 'delete', $this->data['Bookmark']['id']), null, sprintf(__('Are you sure you want to delete this bookmark?', true), $this->data['Bookmark']['id'])) ; ?></li>
	</ul>
</div>
...
<div class="bookmarks_form">
	...
	<?php echo $this->Form->input('Keyword.title', array('label' => __('new keyword', true))); ?>
